...
#include <cstring>
 ...
 int main(){
 	...
 	int n;
 	cout<<"Kac ogrencini notunu gireceksiniz?";
 	cin>>n;
 	for(int i=0; i<n; ++i){
 		cout<<"Ogrencinin adini, soyadini; quiz, vize ve final notlarini giriniz:";
	 ...
	 for(int i=0; i<n; ++i){
	 	...
	 	cout<<"Ortalamasi: "<<ogrenciler[i].ortalama<<" "<<"Harf notu: "<<ogrenciler[i].harf_notu<<endl;
	 }
	 return 0;
 }
